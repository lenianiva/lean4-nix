      ...
      in
        (all: all // all.lean) rec {
          ...
          lean-all = stdenv.mkDerivation {
            ...
            buildCommand = ''
              mkdir -p $out/bin $out/lib/lean
              ln -sf ${leancpp}/lib/lean/* ${lib.concatMapStringsSep " " (l: "${l.modRoot}/* ${l.staticLib}/*") (lib.reverseList stdlib)} ${libInit_shared}/* ${leanshared}/* ${leanshared_1}/* ${leanshared_2}/* ${Lake.sharedLib}/* $out/lib/lean/
